...
const ChatContainer = ({ setSelectedUser, selectedUser }) => {
  ...
  return selectedUser ? (
    <div className="h-full overflow-scroll relative backdrop-blur-lg">
      ...
      <div className="flex flex-col h-[calc(100%-120px)] overflow-y-scroll p-3 pb-6">
        {messagesDummyData.map((msg, index) => (
          <div
            key={index} className={`flex items-end gap-2 justify-end ${ msg.senderId !== "680f50e4f10f3cd28382ecf9" && "flex-row-reverse justify-start" }`}>
            {msg.image ? (
    ...
    <div
      className="fIex flex-col items-center justify-center gap-2 text-gray-500
